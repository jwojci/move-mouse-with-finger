...
<video src="https://github.com/jwojci/move-mouse-with-finger/blob/main/demo/demo.mp4" controls="false" autoplay="true" loop="true" muted="true" playsinline="true" width="100%"></video>
